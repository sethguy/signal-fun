...
(function(global) {
    ...
    function loadByteBuffer(Long) {
        ...
        ByteBuffer.fromDebug = function(str, littleEndian, noAssert) {
            ...
            var i = 0,
                ...
                ho = false,
                hm = false,
                hl = false, // Already has offset, markedOffset, limit?
                fail = false;
            while (i < k) {
                switch (
                ch = str.charAt(i++)) {
    ...
    /* AMD */
        ...
        define("ByteBuffer", ["Long"], function(Long) {
            return loadByteBuffer(Long);
        });
        /* Global */ else
    ...
    ProtoBuf.Reflect = (function(ProtoBuf) {
        ...
        ElementPrototype.verifyValue = function(value) {
            ...
            function fail(val, msg) {
                throw Error("Illegal value for " + JSON.stringify(self) + " of type " + self.type.name + ": " + val + " (" + msg + ")");
            }
            switch (this.type) {
                // Signed 32bit
            ...
            var clazz = (function(ProtoBuf, T) {
                ...
                var Message = function(values, var_args) {
                    ...
                    for (i = 0, k = fields.length; i < k; ++i) {
                        var field = fields[i];
                        this[field.name] = field.repeated ? [] :
